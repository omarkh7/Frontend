...
function DashWriteupsandprojects() {
  const form = useRef();
  ...
  const [newInfo, setNewInfo] = useState({
    ...
    info_description: "",
    info_image: null,
    info_category: "Writeups & Projects",
  });
      ...
      <div className="container-info">
        ...
        <div>
          <table>
            ...
            <tbody>
              {infos
                .filter((info) => info.info_category[0] === "Writeups & Projects")
                .map((info, index) => (
                  <tr key={index}>
                    <td>{index + 1}</td>
...
export default DashWriteupsandprojects;
