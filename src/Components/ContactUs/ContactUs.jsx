        ...
        <div className="rowss">
          ...
          <form ref={form} onSubmit={onSubmit} className="form">
            ...
            <div className="social-media">
              <h5 class="titles">Reach Me Out Via:</h5>
              <div class="social">
                <a href="https://www.facebook.com/dragon.shaheen1">
                  <i>
                    {" "}
                    <TfiFacebook size="18" />
                  </i>{" "}
                </a>
                <a href="https://www.linkedin.com/in/ahmad-halabi-250242155/">
                  {" "}
                  <i>
                    <TfiLinkedin size="18" />
                  </i>
                </a>
                <a href="https://twitter.com/Ahmad_Halabi_">
                  <FontAwesomeIcon icon={faTwitter} size="1x"></FontAwesomeIcon>
                </a>
                <a href="https://www.instagram.com/ahmad_shn1/">
                  <FontAwesomeIcon
                    icon={faInstagram}
                    size="1x"
                  ></FontAwesomeIcon>{" "}
